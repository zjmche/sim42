...
from ..thermo.pr_eos_tdep import enthalpy as _enthalpy, wilson_K
...
def _initialize(cfg: ColumnConfig, mix: MixtureTD):
    ...
    from ..equilibrium.bubble_dew_tdep import bubble_T as _bt
    z = cfg.feed.z
...
def _enthalpy_feed(cfg: ColumnConfig, mix: MixtureTD) -> float:
